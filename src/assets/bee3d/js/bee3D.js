var Bee3D = (function() {
	...
	function o(e) {
		...
		for (var i = 1; i < arguments.length; i++) {
			...
			for (var a in n) e[a] = t(n[a]) ? o(e[a], n[a]) : n[a];
		}
		return e;
	}
	function a() {
		if (l.XMLHttpRequest) return new l.XMLHttpRequest();
		try {
	...
	var l = window,
		...
		u = {
			...
			autoplay: { enabled: !1, speed: 5e3, pauseHover: !1 },
			loop: { enabled: !1, continuous: !1, offset: 2 },
			sync: { enabled: !1, targets: [] },
			parallax: {
				enabled: !1,
		...
		f = function(e, t) {
			...
			(l.onreadystatechange = function() {
				...
				i &&
					(s(n, 'X-Requested-With', 'XMLHttpRequest'),
		...
		h = function() {
			...
			t(),
				...
				e.el.on('activate', i),
				e.options.autoplay.pauseHover &&
					e.el.on('activate', function(t) {
			...
			var e = this,
				...
				o = function(i, o) {
					n(i, 'click', function(t) {
						return (
							t.preventDefault(), o ? e.el.next() : e.el.prev()
						);
					}),
						t.autoplay.enabled &&
							t.autoplay.pauseHover &&
							e.listenToHover(i);
				},
			...
			if (l.Parallax) {
				for (
					var t = this,
						n = t.options,
						i = n.shadows.enabled,
						o = n.parallax.className,
						a = n.parallax.friction,
						s = n.parallax.settings,
						r = function(e) {
					...
					var u = e[c];
					r(u.firstElementChild), i && r(u.lastChild);
				}
				(s.className = o),
					(t._parallax = new Parallax(
						t.el.parent,
						n.parallax.settings
					)),
				...
				c = function(e, n) {
					...
					if (i !== e)
						return arguments.length
							? (s('slide', a(t[e], n)), void l(e, n))
							: i;
				},
				u = function(e, i) {
					var o = t.indexOf(n) + e;
					s(e > 0 ? 'next' : 'prev', a(n, i)), l(o, i);
				},
				f = function(e, t) {
					return (
						(i[e] = (i[e] || []).concat(t)),
		...
		S = function() {
			...
			for (
				var i = '.bee3D--slide' === this.options.selector, o = 0;
				o < t.length;
				o++
			)
				t[o].className = i
					? 'bee3D--slide'
					: t[o].className.replace(n, '');
			this.el.fire('destroy');
			var a = this.options.onDestroy;
			(this.options = u), this.plugins(), a();
		};
	return (
		(r.prototype = {
			init: function(e) {
				...
				(this.el = k(n)),
					...
					classie.add(
						this.el.parent,
						'bee3D--effect__' + this.options.effect
					),
					this.events(),
					this.slideEvents(),
					this.options.onInit(),
